...
public class DijbekerokFrame extends javax.swing.JFrame
{
    private PopupTimer popupTimer;
    
    private String keres = "1";
    private boolean b = true;
    private boolean isKintlevoseg;
    ...
    public FrissitesThread frissitesThread = new FrissitesThread();
    
    /**
     * Creates new form DijbekerokFrame
     */
    public DijbekerokFrame()
    {
        initComponents();
        init();
        String workingDir = System.getProperty("user.dir");
        File [] folders = {new File("dokumentumok/csatolmanyok/kintlevoseg/"), new File(workingDir)};
        deletePDFs(folders);
    }
    ...
    private void initComponents() {
        ...
        ujSzamlaProFormaAlapjanMenuItem1 = new javax.swing.JMenuItem();
        ...
        selectAllInvoice = new javax.swing.JCheckBox();

        szamlaPopupMenu.setName("szamlaPopupMenu"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cezeszamlazo.App.class).getContext().getResourceMap(DijbekerokFrame.class);
        masolatMenuItem.setText(resourceMap.getString("masolatMenuItem.text")); // NOI18N
        masolatMenuItem.setToolTipText(resourceMap.getString("masolatMenuItem.toolTipText")); // NOI18N
        ...
        ujSzamlaProFormaAlapjanMenuItem1.setText(resourceMap.getString("ujSzamlaProFormaAlapjanMenuItem1.text")); // NOI18N
        ujSzamlaProFormaAlapjanMenuItem1.setToolTipText(resourceMap.getString("ujSzamlaProFormaAlapjanMenuItem1.toolTipText")); // NOI18N
        ujSzamlaProFormaAlapjanMenuItem1.setName("ujSzamlaProFormaAlapjanMenuItem1"); // NOI18N
        ujSzamlaProFormaAlapjanMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ujSzamlaProFormaAlapjanMenuItem1ActionPerformed(evt);
            }
        });
        szamlaPopupMenu.add(ujSzamlaProFormaAlapjanMenuItem1);

        jSeparator5.setName("jSeparator5"); // NOI18N
        szamlaPopupMenu.add(jSeparator5);
        ...
        szamlaPopupMenu.add(deleteMenuItem);
            ...
            .addGroup(nyomtatasDialogLayout.createSequentialGroup()
                ...
                .addGroup(nyomtatasDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, nyomtatasDialogLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(printerComboBox, 0, 216, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(resourceMap.getColor("jPanel7.border.border.lineColor"), 1, true), resourceMap.getString("jPanel7.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, resourceMap.getFont("jPanel7.border.titleFont"))); // NOI18N
        ...
        szamlakTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sorszám", "Vevő", "Kelt", "Nettó", "Áfa érték", "Bruttó", "Fizetendő", "Fennmaradó", "Esedékesség", "Teljesítés", "Kifizetés", "Késedelem", "Becsült kamat", "Fizetési mód", "Megjegyzés", "Valuta", "Középárfolyam", "Azonosító", "Title 19", "Title 20", "Title 21"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, true, true, true
            };
        ...
        nemNyomtatottCheckBox.setToolTipText(resourceMap.getString("nemNyomtatottCheckBox.toolTipText")); // NOI18N
        ...
        EasySearchComboBox.setFont(resourceMap.getFont("EasySearchComboBox.font")); // NOI18N
        ...
        selectAllInvoice.setText(resourceMap.getString("selectAllInvoice.text")); // NOI18N
        selectAllInvoice.setToolTipText(resourceMap.getString("selectAllInvoice.toolTipText")); // NOI18N
        selectAllInvoice.setName("selectAllInvoice"); // NOI18N
        selectAllInvoice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectAllInvoiceActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(szamlaScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 374, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            kintlevosegMenuPDF.setVisible(true);
    ...
    private void masolatMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_masolatMenuItemActionPerformed
        ...
        String indentifier = szamlakTable.getValueAt(row, 17).toString();
        Invoice invoice = new Invoice(Invoice.PROFORMA, Invoice.InvoiceType.COPY, "szamlazo_pro_forms", indentifier);
    ...
    private void szamlakTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_szamlakTableMouseClicked
        ...
        {
            folyamatbanDialog = new FolyamatbanDialog("Díjbekérő adatok betöltése...");
    ...
    private void kifizetesMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kifizetesMenuItemActionPerformed
        ...
        if (rows.length == 1)
        {
            SzamlaKifizetesDialog k = new SzamlaKifizetesDialog(
                    ...
                    String.valueOf(szamlakTable.getValueAt(rows[0], 17)),
        ...
        else
        {
            ...
            for (int i = 0; i < rows.length; i++)
            {
                ...
                ids[i][1] = String.valueOf(szamlakTable.getValueAt(rows[i], 17));
                ids[i][2] = String.valueOf(szamlakTable.getValueAt(rows[i], 7));
            }
            SzamlaKifizetesDialog k = new SzamlaKifizetesDialog(ids, Invoice.PROFORMA);
            if (k.getReturnStatus() == 1)
            {
                frissites();
            }
    ...
    private void nyomtatasMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nyomtatasMenuItemActionPerformed
        ...
        if (rows.length != 0)
        {
            for (int i = 0; i < rows.length; i++)
            {
                nyomtatasAzon = String.valueOf(szamlakTable.getValueAt(rows[i], 17));
                
                Query query = new Query.QueryBuilder()
                    .select("printed")
                    .from("szamlazo_pro_forms")
                    .where("indentifier = '" + nyomtatasAzon + "'")
                    .build();
    ...
    private void printingPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_printingPanelMouseClicked
        Invoice invoice = new Invoice(Invoice.PROFORMA, Invoice.InvoiceType.ORIGINAL, "szamlazo_pro_forms", nyomtatasAzon);
...
private void kintlevosegLevelEmailMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kintlevosegLevelEmailMenuItemActionPerformed
    ...
    for (int i = 0; i < rows.length; i++)
    {
        ...
        azonositok[i] = String.valueOf(szamlakTable.getValueAt(rows[i], 17));        
    }
...
//        kintlevosegPDF(azonositok, true);
    ...
    private void deleteMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteMenuItemActionPerformed
        ...
        String fizetendo = String.valueOf(szamlakTable.getValueAt(row, 6));
        String fennmarado = String.valueOf(szamlakTable.getValueAt(row, 7));
        if(fizetendo.equals(fennmarado))
        {
            String indentifier = String.valueOf(szamlakTable.getValueAt(row, 17));
            String query = "DELETE FROM szamlazo_pro_forms WHERE indentifier = " + indentifier;
            App.db.delete(query);
            query = "DELETE FROM szamlazo_pro_form_products WHERE indentifier = " + indentifier;
            App.db.delete(query);
            frissites();
        }
        else
        {
            System.err.println("Csak olyan számlát törölhet amiből még nem lett fizetve!");
        }       
    }//GEN-LAST:event_deleteMenuItemActionPerformed

    private void selectAllInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectAllInvoiceActionPerformed
        frissites();
    }//GEN-LAST:event_selectAllInvoiceActionPerformed
    ...
    private void ujSzamlaProFormaAlapjanMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ujSzamlaProFormaAlapjanMenuItem1ActionPerformed
        int row = szamlakTable.getSelectedRow();
        
        String indentifier = szamlakTable.getValueAt(row, 17).toString();
        Invoice invoice = new Invoice(Invoice.INVOICE, Invoice.InvoiceType.COPY, "szamlazo_pro_forms", indentifier);
        invoice.setType(Invoice.INVOICE);
        //InvoiceView view = new InvoiceView(invoice);
        ResizeableInvoiceView view = new ResizeableInvoiceView(invoice);
    }//GEN-LAST:event_ujSzamlaProFormaAlapjanMenuItem1ActionPerformed

    private void szamlakTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_szamlakTableMousePressed
        popupTimer = new PopupTimer();
        popupTimer.Start();
    }//GEN-LAST:event_szamlakTableMousePressed
    ...
    private javax.swing.JCheckBox selectAllInvoice;
    ...
    private javax.swing.JMenuItem ujSzamlaProFormaAlapjanMenuItem1;
...
//        kintlevosegCheckBox.addActionListener(actionListener2);
    ...
    private void deletePDFs(File [] folders)
    {
        for(int i = 0; i < folders.length; i++)
        {
            ...
            for(int j = 0; j < listOfFiles.length; j++)
            {
                ...
                //System.err.println(fileName + "." + extension);
                //= fileName.split(".")[1];
                //= FilenameUtils.getExtension("bar.exe");
    ...
    public void frissites()
    {
        ...
        if(!selectAllInvoice.isSelected())
        {
            keres += " && p.invoiceNumber LIKE '%" + year + "%'";
        }
        
        String keresText = EncodeDecode.encode(kereses.getText().replace("'", "\\\'"));
        
        keres += " && (p.invoiceNumber LIKE '%" + keresText + "%' || p.customerName LIKE '%" + keresText + "%')";
        ...
        {
            keres += " || p.paymentDate = '0000-00-00'";
        }
        
        if (normal.isSelected())
        {
            keres += " || invoiceType = 'NEW'";
        }

        if (helyesbito.isSelected())
        {
            keres += " || invoiceType = 'CORRECTION' || invoiceType = 'MODIFICATION' || invoiceType = 'STORNO'";
        }
        
        if (helyesbitett.isSelected())
        {
            keres += " || invoiceType = 'GOTSTORNO'";
        }
        ...
        {
            keres += " || p.paymentMethod = 0";
        }
        if (atutalasCheckBox.isSelected())
        {
            keres += " || p.paymentMethod = 1";
        }
        if (utanvetCheckBox.isSelected())
        {
            keres += " || p.paymentMethod = 2";
        }
        ...
        {
            keres += " && p.issueDate BETWEEN '" + (keltTol.getText().isEmpty() ? "0000-00-00" : keltTol.getText()) + "' AND " + (keltIg.getText().isEmpty() ? "NOW()" : "'" + keltIg.getText() + "'");
        }
        if (!teljesitesTol.getText().isEmpty() || !teljesitesIg.getText().isEmpty())
        {
            keres += " && p.completionDate BETWEEN '" + (teljesitesTol.getText().isEmpty() ? "0000-00-00" : teljesitesTol.getText()) + "' AND " + (teljesitesIg.getText().isEmpty() ? "NOW()" : "'" + teljesitesIg.getText() + "'");
        }
        if (!esedekessegTol.getText().isEmpty() || !esedekessegIg.getText().isEmpty())
        {
            keres += " && p.maturityDate BETWEEN '" + (esedekessegTol.getText().isEmpty() ? "0000-00-00" : esedekessegTol.getText()) + "' AND " + (esedekessegIg.getText().isEmpty() ? "NOW()" : "'" + esedekessegIg.getText() + "'");
        }
        if (!kifizetesTol.getText().isEmpty() || !kifizetesIg.getText().isEmpty())
        {
            keres += " && p.paymentDate BETWEEN '" + (kifizetesTol.getText().isEmpty() ? "0000-00-00" : kifizetesTol.getText()) + "' AND " + (kifizetesIg.getText().isEmpty() ? "NOW()" : "'" + kifizetesIg.getText() + "'");
        }
        
        DefaultTableModel DTModel = (DefaultTableModel) szamlakTable.getModel();
        
        String[] header = {"Sorszám", "Vevő", "Kelt", "Nettó", "Áfaérték", "Bruttó", "Fizetendő", "Fennmaradó", "Esedékesség", "Teljesítés", "Kifizetés", "Késedelem", "Becsült kamat", "Fizetési mód", "Megjegyzés", "Valuta", "Középárfolyam", "Azonosító"};
        ...
        Query query = new Query.QueryBuilder()
            .select("p.invoiceNumber, "
                ...
                + "p.netPrice, "
                + "p.vatAmount, "
                + "p.netPrice + p.vatAmount, " //bruttó
                + "p.netPrice + p.vatAmount, " //fizetendő
                + "p.netPrice + p.vatAmount - (SELECT IF(SUM(amountPaid) IS NULL, 0, SUM(amountPaid)) from szamlazo_pro_form_payments  WHERE invoiceNumber = p.invoiceNumber && indentifier = p.indentifier), "//fennmaradó
                + "maturityDate, "
                + "completionDate, "
                + "paymentDate, "
                + "CONCAT(IF(paymentDate = '0000-00-00', IF(DATEDIFF(NOW(), maturityDate) < 0, 0, DATEDIFF(NOW(), maturityDate)), DATEDIFF(paymentDate, maturityDate)), ' nap'), "//késedelem
                + "(p.netPrice + p.vatAmount) * (SELECT alapkamat from szamlazo_jegybanki_alapkamat) / 100 * 2 / 365 * IF(paymentDate = '0000-00-00', IF(DATEDIFF(NOW(), maturityDate) < 0, 0, DATEDIFF(NOW(), maturityDate)), DATEDIFF(paymentDate, maturityDate)), "//becsült kamat
                + "p.paymentMethod, "
                + "p.comment, "
                + "p.currency, "
                + "p.centralParity, "
                + "p.indentifier ")
            .from("szamlazo_pro_forms p")
        ...
        {
            if(result[i][10].toString().equals("0000-00-00"))
            {
                result[i][10] = "";
            }
        }
    ...
    private void osszesit(int col)
    {
        ...
        if (rows.length == 0)
        {
            ...
            {
                if (!String.valueOf(szamlakTable.getValueAt(i, 15)).equalsIgnoreCase("huf"))
                {
                    o += (int) Math.round(Double.parseDouble(String.valueOf(szamlakTable.getValueAt(i, col))) * Double.parseDouble(String.valueOf(szamlakTable.getValueAt(i, 16))));
                }
                else
                {
        ...
        else
        {
            for (int i = 0; i < rows.length; i++)
            {
                if (!String.valueOf(szamlakTable.getValueAt(rows[i], 15)).equalsIgnoreCase("huf"))
                {
                    o += (int) Math.round(Double.parseDouble(String.valueOf(szamlakTable.getValueAt(rows[i], col))) * Double.parseDouble(String.valueOf(szamlakTable.getValueAt(rows[i], 16))));
                }
                else
                {
    ...
    private void kintlevosegPDF(String[] azonositok, boolean egybeVagyKulon)
    {
        try
        {
            ...
            kintlevosegLevel.createPDF(azonositok, egybeVagyKulon, true, isKintlevoseg);
        }
    ...
    private void kintlevosegLevel(String[] azonositok, boolean egybeVagyKulon)
    {
        try
        {
            ...
            kintlevosegLevel.createEmail(azonositok, egybeVagyKulon, true, isKintlevoseg);
        }
        catch (KintlevosegLevelException exception)
        {
            HibaDialog h = new HibaDialog("Nincs kintlévőség kiválasztva!", "", "Ok");
    ...
    class SzamlaAdatokThread extends Thread
    {
        ...
        public void run()
        {
            SzamlaAdatokDialog sz = new SzamlaAdatokDialog(Invoice.PROFORMA, Invoice.InvoiceType.NEW, "szamlazo_pro_forms", String.valueOf(szamlakTable.getValueAt(row, 17)));
    ...
    class PdfThread extends Thread
    {
        ...
        {
            String indentifier = String.valueOf(szamlakTable.getValueAt(row, 17));
            Invoice invoice = new Invoice(Invoice.PROFORMA, Invoice.InvoiceType.ORIGINAL, "szamlazo_pro_forms", indentifier);
    ...
    class TeljesitesIgazolasNyomtatasThread extends Thread
    {
        ...
        public void run()
        {
            String indentifier = szamlakTable.getValueAt(row, 18).toString();
            Invoice invoice = new Invoice(Invoice.COMPLETION_CERTIFICATE, Invoice.InvoiceType.ORIGINAL, "szamlazo_pro_forms", indentifier);
            //InvoiceView view = new InvoiceView(invoice);
            ResizeableInvoiceView view = new ResizeableInvoiceView(invoice);
